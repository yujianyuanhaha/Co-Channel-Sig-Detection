...
%       verbose option
%   Modified: Thursday Sept 24, 2015
%       improved message passing flow
...
for w=1:sys.numIter
    ...
    for z=1:sys.numDetectIter
        ...
        for i=1:sys.frameLen
            ...
            hIN = [ h1( hIdx ); h2( hIdx ) ];
            Xout = factor_detect_approx( r(i) , Xin , hIN , sigmasqrd , sys.C , Xconst_fctr , sys.eta );
...
for ww=w+1:sys.numIter
    ...
    for z=1:sys.numDetectIter
        ...
        for i=1:sys.frameLen
            ...
            Xin = X_u1(i,colIdx).';
            hIN = h1( hIdx );
            Xout = factor_detect_approx( rr(i) , Xin , hIN , sigmasqrd , sys.C , Xconst_fctr , sys.eta );
            X_u1(i,colIdx) = Xout.';
